...
ceiling `previewMint` via `mulDivCeil`, ceiling `previewWithdraw` via `mulDivCeil`, closed ERC-20 asset
movement, and ordered reentrancy lock around external calls. Empty supply is 1:1. Virtual +1 when
supply is nonzero.
-/
