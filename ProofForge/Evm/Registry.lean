...
def entries : Array Entry := #[
  ...
  { name := "Collectible", digest := "b6d85c01f48dfb4" },
  { name := "Badge", digest := "8af5120d8156dba8" },
  ...
  { name := "MultiToken", digest := "a4599f00febf60b0" },
  { name := "CraftToken", digest := "7ed88d8af73754b4" },
