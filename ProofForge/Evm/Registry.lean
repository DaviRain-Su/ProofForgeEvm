...
def entries : Array Entry := #[
  ...
  { name := "VestLink", digest := "86c8363611ee3cc7" },
  { name := "Vest20Link", digest := "9a9cce6e0d2a58a2" },
  ...
  { name := "TwoStepCounter", digest := "f53ac3264ec9cf51" },
  { name := "Credits", digest := "9bbe0424c5bc56d0" },
