...
def entries : Array Entry := #[
  ...
  { name := "Collectible", digest := "b1d756fc4fc70ed0" },
  { name := "Badge", digest := "486420c933cdc7ac" },
  ...
  { name := "MultiToken", digest := "6792ca0e2ed8f217" },
  { name := "CraftToken", digest := "138f8b80bb24975b" },
  { name := "TwoStepCounter", digest := "8aa4d044a935390e" },
  { name := "Credits", digest := "3447fa1464d2897a" },
