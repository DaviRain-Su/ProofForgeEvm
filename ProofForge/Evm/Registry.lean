...
def entries : Array Entry := #[
  ...
  { name := "VestLink", digest := "897a7934eb6291be" },
  { name := "Vest20Link", digest := "226bbefeac922a65" },
  ...
  { name := "Auth3009Link", digest := "3f8b259e6f5b6c23" },
  ...
  { name := "TwoStepCounter", digest := "5c233c3f25cd6488" },
  { name := "Credits", digest := "cd76930e05d07045" },
