...
@[pf_inline] def mulDivOffset256 (a b d : UInt256) : UInt256 :=
  evmMulDivOffset256 a b d

@[pf_inline] def mulDivOffsetW0 (a b d : UInt256) : UInt64 := (evmMulDivOffset256 a b d).w0
@[pf_inline] def mulDivOffsetW1 (a b d : UInt256) : UInt64 := (evmMulDivOffset256 a b d).w1
@[pf_inline] def mulDivOffsetW2 (a b d : UInt256) : UInt64 := (evmMulDivOffset256 a b d).w2
@[pf_inline] def mulDivOffsetW3 (a b d : UInt256) : UInt64 := (evmMulDivOffset256 a b d).w3
...
@[pf_inline] def mulDivOffsetRev256 (a b d : UInt256) : UInt256 :=
  evmMulDivOffsetRev256 a b d

@[pf_inline] def mulDivOffsetRevW0 (a b d : UInt256) : UInt64 := (evmMulDivOffsetRev256 a b d).w0
@[pf_inline] def mulDivOffsetRevW1 (a b d : UInt256) : UInt64 := (evmMulDivOffsetRev256 a b d).w1
@[pf_inline] def mulDivOffsetRevW2 (a b d : UInt256) : UInt64 := (evmMulDivOffsetRev256 a b d).w2
@[pf_inline] def mulDivOffsetRevW3 (a b d : UInt256) : UInt64 := (evmMulDivOffsetRev256 a b d).w3

@[pf_inline] def mulDivOffsetRev (a b d : UInt256) : UInt256 :=
  ⟨mulDivOffsetRevW0 a b d, mulDivOffsetRevW1 a b d, mulDivOffsetRevW2 a b d, mulDivOffsetRevW3 a b d⟩
...
@[pf_inline] def mulDivCeilOffset256 (a b d : UInt256) : UInt256 :=
  evmMulDivCeilOffset256 a b d

@[pf_inline] def mulDivCeilOffsetW0 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffset256 a b d).w0
@[pf_inline] def mulDivCeilOffsetW1 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffset256 a b d).w1
@[pf_inline] def mulDivCeilOffsetW2 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffset256 a b d).w2
@[pf_inline] def mulDivCeilOffsetW3 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffset256 a b d).w3

@[pf_inline] def mulDivCeilOffset (a b d : UInt256) : UInt256 :=
  ⟨mulDivCeilOffsetW0 a b d, mulDivCeilOffsetW1 a b d, mulDivCeilOffsetW2 a b d,
    mulDivCeilOffsetW3 a b d⟩

@[pf_inline] def mulDivCeilOffsetRev256 (a b d : UInt256) : UInt256 :=
  evmMulDivCeilOffsetRev256 a b d

@[pf_inline] def mulDivCeilOffsetRevW0 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffsetRev256 a b d).w0
@[pf_inline] def mulDivCeilOffsetRevW1 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffsetRev256 a b d).w1
@[pf_inline] def mulDivCeilOffsetRevW2 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffsetRev256 a b d).w2
@[pf_inline] def mulDivCeilOffsetRevW3 (a b d : UInt256) : UInt64 := (evmMulDivCeilOffsetRev256 a b d).w3

@[pf_inline] def mulDivCeilOffsetRev (a b d : UInt256) : UInt256 :=
  ⟨mulDivCeilOffsetRevW0 a b d, mulDivCeilOffsetRevW1 a b d, mulDivCeilOffsetRevW2 a b d,
    mulDivCeilOffsetRevW3 a b d⟩
