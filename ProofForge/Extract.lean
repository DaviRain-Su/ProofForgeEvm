...
def decodeMutating (env : Environment) (e : Expr) (stateType? : Option Name := none) :
  ...
  if Ops.hasCheckedArith ops || writesOptionLeaf 8 ops || hasIte ops ||
      Ops.hasEvmEffect ops || Ops.hasLangOp ops ||
...
def extractMethod (env : Environment) (kind : Core.IR.MethodKind) (n : Name) :
  ...
  let rec flipOp (fuel : Nat) (op : Ops.Op) : Ops.Op :=
    ...
    | fuel' + 1 =>
      ...
      -- Psy-target effects; unreachable for EVM sources but the shared Core
      ...
      | .externalCall callee args =>
          .externalCall callee ((args.map (flipVal fuel')))
      ...
      | .evmReceiveWithAuthorization f0 f1 f2 t0 t1 t2 v0 v1 v2 v3 a0 a1 a2 a3 b0 b1 b2 b3 n0 n1 n2 n3 vv r0 r1 r2 r3 z0 z1 z2 z3 =>
          .evmReceiveWithAuthorization (flipVal fuel' f0) (flipVal fuel' f1) (flipVal fuel' f2)
            (flipVal fuel' t0) (flipVal fuel' t1) (flipVal fuel' t2)
            (flipVal fuel' v0) (flipVal fuel' v1) (flipVal fuel' v2) (flipVal fuel' v3)
            (flipVal fuel' a0) (flipVal fuel' a1) (flipVal fuel' a2) (flipVal fuel' a3)
            (flipVal fuel' b0) (flipVal fuel' b1) (flipVal fuel' b2) (flipVal fuel' b3)
  ...
  let rec goOp (fuel : Nat) (op : Ops.Op) : Except String Ops.Op :=
    ...
    | fuel' + 1 =>
      ...
      | .emitEvent name payload =>
          return .emitEvent name (← normalizeVal payload)
      | .externalCall callee args =>
      ...
      | .evmTransferWithAuthorization f0 f1 f2 t0 t1 t2 v0 v1 v2 v3 a0 a1 a2 a3 b0 b1 b2 b3 n0 n1 n2 n3 vv r0 r1 r2 r3 z0 z1 z2 z3 =>
          return .evmTransferWithAuthorization (← normalizeVal f0) (← normalizeVal f1) (← normalizeVal f2)
            ...
            (← normalizeVal z0) (← normalizeVal z1) (← normalizeVal z2) (← normalizeVal z3)
      | .evmReceiveWithAuthorization f0 f1 f2 t0 t1 t2 v0 v1 v2 v3 a0 a1 a2 a3 b0 b1 b2 b3 n0 n1 n2 n3 vv r0 r1 r2 r3 z0 z1 z2 z3 =>
          return .evmReceiveWithAuthorization (← normalizeVal f0) (← normalizeVal f1) (← normalizeVal f2)
            (← normalizeVal t0) (← normalizeVal t1) (← normalizeVal t2)
            (← normalizeVal v0) (← normalizeVal v1) (← normalizeVal v2) (← normalizeVal v3)
            (← normalizeVal a0) (← normalizeVal a1) (← normalizeVal a2) (← normalizeVal a3)
            (← normalizeVal b0) (← normalizeVal b1) (← normalizeVal b2) (← normalizeVal b3)
