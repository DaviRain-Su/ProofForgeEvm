...
8. **`Examples.Evm.Auth3009Link`** — bounded ERC-3009 `transferWithAuthorization` and `receiveWithAuthorization`. Receive uses the `ReceiveWithAuthorization` typehash and requires `caller == to`. Cancellation is out.
