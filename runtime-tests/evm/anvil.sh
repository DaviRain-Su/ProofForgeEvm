...
ran=0
skipped=0
for case in counter pair flag maybe ctx bounded search find_index static_counter static_roster evmquota \
    ...
    ownable token erc20meta safepay royaltyart window phase wide const capped multitoken crafttoken twostep_counter credits \
    opencall; do
