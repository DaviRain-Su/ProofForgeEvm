...
pf_evm_evm_init evm-anvil-wide
bin="$root/build/evm/Wide.bin"
pf_evm_ensure_bin "$bin"
pf_evm_start_anvil "${PF_EVM_PORT:-18557}" "$root/build/evm/anvil-wide.log"
...
pf_evm_require_equal "${got_bytes12,,}" "$bytes12" "shared bytes12 echo"
