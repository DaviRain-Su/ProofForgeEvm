...
REQUIRED = (
    ...
    (ROOT / "ProofForge" / "Evm" / "Registry.lean", 'digest := "87acbed203c29f11"'),
    (ROOT / "Tests" / "EvmVestingSpec.lean", 'IR.digestHex program == "87acbed203c29f11"'),
    (ROOT / "ProofForge" / "Evm" / "Registry.lean", 'digest := "f07336584ca318a"'),
    (ROOT / "Tests" / "EvmVest20Spec.lean", 'IR.digestHex program == "f07336584ca318a"'),
