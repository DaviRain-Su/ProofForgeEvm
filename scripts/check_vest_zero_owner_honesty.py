#!/usr/bin/env python3
"""Fail when product docs still list constructor CREATE ZeroAddress as missing.
...
REQUIRED = (
    ...
    (ROOT / "docs" / "product" / "support-matrix.md", "ZeroAddress()"),
    (ROOT / "docs" / "product" / "writing-contracts.md", "Revert.zeroAddress"),
)
